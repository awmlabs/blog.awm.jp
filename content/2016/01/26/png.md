...
## Type:0 グレースケール
 ...
 黒:0〜白:2^(bit数)-1 の範囲の値を並べるだけの形式です。
bit数は 1,2,4,8,16 から選択できて、例えば、bit数が 1 であれば白黒2値の 1 or 0。bit 数が 8 であれば、0〜255=(2^8-1) の階調を持ちます。
...
ただし、残念なが ImageMagick は対応していません。。
